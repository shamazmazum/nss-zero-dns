...
static int __nss_bsdcompat_getaddrinfo(void* retval, void* mdata __unused,
    ...
    extern enum nss_status _nss_zerodns_gethostbyname_impl(
        const char* name, int af, userdata_t* u, int* errnop, int* h_errnop);

    status = _nss_zerodns_gethostbyname_impl(name, pai->ai_family, &u, &_errno,
                                             &_h_errno);
...
static int __nss_bsdcompat_gethostbyaddr_r(void* retval, void* mdata __unused,
    ...
    *resultp = NULL;
    status = _nss_zerodns_gethostbyaddr_r(addr, len, af, hp, buf, buflen,
                                          &ret_errno, h_errnop);
...
static int __nss_bsdcompat_gethostbyname2_r(void* retval, void* mdata __unused,
    ...
    *resultp = NULL;
    ...
    status = _nss_zerodns_gethostbyname2_r(name, af, hp, buf, buflen, &ret_errno,
                                           h_errnop);
...
static int __nss_bsdcompat_ghbyaddr(void* retval, void* mdata __unused,
    ...
    status = _nss_zerodns_gethostbyaddr_r(src, len, af, hp, buffer, buflen, errp,
                                          &h_errnop);
...
static int __nss_bsdcompat_ghbyname(void* retval, void* mdata __unused,
    ...
    status =
        _nss_zerodns_gethostbyname_r(name, hp, buffer, buflen, errp, &h_errnop);
